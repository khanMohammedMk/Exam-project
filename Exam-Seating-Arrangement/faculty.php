			...
			<div class="header-nav">
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					 ...
					 <li class="hvr-sweep-to-bottom active"><a href="index.html" class="scroll"> Project</a></li>
...
if($_POST){
	if(isset($_POST['invg'])){
		...
		$n=$_POST['invg'];
		$q="SELECT * FROM faculty WHERE instructure_name='$n'";
		$q2=@mysqli_query($conn,$q) or die(mysqli_error($conn));
		$row = mysqli_fetch_array($q2);
		echo "FACULTY NAME:  ";
		echo $n."<br>";
		echo "ROOM Number:  ";    echo $row['room_no'];   echo "<br>";
