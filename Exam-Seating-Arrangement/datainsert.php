      ...
      <div class="col-xs-4 col-xs-push-4">
        ...
        <center><h2>SEATING ARRANGEMENT FILLING<h2></center>
          ...
          <div class="panel panel-default">
            ...
            <form class="form-horizontal  content" action="subjectDetailProcess.php" method="post" role="form">
             ...
             <div class="form-group text-control">
               <div class="row">
                 <div class="col-xs-7">
               <label for="numberstart" class="enroll-control">Enrollment Number :<font style="color:#FF0000">*</font></label>
...
// $endtime=$etime;
if($enrollnumber){
$r = mysqli_query($conn,"INSERT INTO trisub(year,department,enrollnumber,subject,classroom,examdate) VALUES('$yy','$dd','$enrollnumber','$subject','$classroom','$examdate')");
